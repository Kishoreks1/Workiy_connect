...
public class EmailService {
    ...
    public static final String EMPLOYEE_APPLY_LEAVE = "employeeApplyLeaveEmail";
    public static final String EMPLOYEE_EDIT_LEAVE = "employeeEditLeaveEmail";
    public static final String EMPLOYEE_CANCLED_LEAVE = "employeeCancelLeaveEmail";
    public static final String EMPLOYEE_REJECT_LEAVE = "employeeRejectLeaveEmail";
    public static final String EMPLOYEE_ACCEPT_LEAVE = "employeeAcceptLeaveEmail";
    public static final String EMPLOYEE_WITHDRAW_LEAVE = "employeeWithdrawLeaveEmail";
    public static final String EMPLOYEE_WITHDRAW_ACCEPT_LEAVE = "employeeWithdrawAcceptLeaveEmail";
    public static final String EMPLOYEE_WITHDRAW_REJECT_LEAVE = "employeeWithdrawRejectLeaveEmail";
    ...
    public EmailService(JavaMailSender mailSender, TemplateEngine templateEngine) {
        ...
        emailTemplates.put(EMPLOYEE_RESET_PASSWORD, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		...
        		+ "</html>\r\n"
        		+ "");
        emailTemplates.put(EMPLOYEE_APPLY_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		...
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Leave Request has applied successfully</p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");
        emailTemplates.put(EMPLOYEE_EDIT_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Leave has edited successfully</p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");

        emailTemplates.put(EMPLOYEE_CANCLED_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Leave has cancled successfully</p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");

        emailTemplates.put(EMPLOYEE_REJECT_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Leave has been rejected by manager </p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");
        emailTemplates.put(EMPLOYEE_ACCEPT_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Leave has been Accepted by manager </p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");
        emailTemplates.put(EMPLOYEE_WITHDRAW_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Withdraw Leave Request has been Sented to the manager </p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");
        emailTemplates.put(EMPLOYEE_WITHDRAW_ACCEPT_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Withdraw Leave Request has been Accepted by manager </p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");

        emailTemplates.put(EMPLOYEE_WITHDRAW_REJECT_LEAVE, "<html xmlns:th=\"http://www.thymeleaf.org\">\r\n"
        		+ "<head>\r\n"
        		+ "    <meta charset=\"UTF-8\"/>\r\n"
        		+ "    <title>Employee Apply Leave</title>\r\n"
        		+ "</head>\r\n"
        		+ "<body>\r\n"
        		+ "    <h1 th:text=\"${title}\">Workiy Connect</h1>\r\n"
        		+ "    <p th:text=\"${content}\">Your Withdraw Leave Request has been Rejected by manager </p>\r\n"
        		+ "</body>\r\n"
        		+ "</html>\r\n"
        		+ "");
